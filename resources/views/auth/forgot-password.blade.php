            ...
            <form method="POST" action="{{ route('password.email') }}" class="auth-login-form auth-register-form mt-4">
                ...
                <div>
                    ...
                    <div class="auth-login-input-wrap">
                        ...
                        <input id="email" class="auth-login-input auth-register-input" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="email" placeholder="Enter your email" />
                    </div>
