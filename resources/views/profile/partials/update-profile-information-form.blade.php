<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <input id="department" name="department" type="text" class="auth-input" value="{{ old('department', $user->department) }}" placeholder="e.g. IT, HR, DOH-NCR">
            <x-input-error class="mt-2" :messages="$errors->get('department')" />
            <p class="mt-1 text-xs text-slate-500">Staff users can access requests for their own department only.</p>
            @php
